...
## Included Projects ##
### Keen ###
This application is pre-loaded at the factory on the WM2000 that is included in each WM2000EV kit. The project requires absolutely no coding by the user, and demonstrates how quick and straightforward configuration of the WM2000 as an IIoT sensor node can be. In as little as 5 minutes, your WM2000 will be securely transmitting sensor data to a nonaffiliated, third-party cloud services provider — [Keen](https://keen.io), in this case.
